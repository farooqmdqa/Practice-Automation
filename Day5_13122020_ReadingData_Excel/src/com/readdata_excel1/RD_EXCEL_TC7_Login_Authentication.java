...
public class RD_EXCEL_TC7_Login_Authentication {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		XSSFRow current_row = sheet.getRow(7);
		...
		if (actual_text.contains(exp_text)) {
			...
			System.out.println("TestCase8 is passed:User stays on Login page");

		}else {

			System.out.println("TestCase8 is failed");
