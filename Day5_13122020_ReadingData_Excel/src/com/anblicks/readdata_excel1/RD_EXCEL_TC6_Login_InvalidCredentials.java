...
public class RD_EXCEL_TC6_Login_InvalidCredentials {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		XSSFRow current_row = sheet.getRow(6);
		...
		if (actual_text.contains(exp_text)) {
			...
			System.out.println("TestCase7 is passed:User entered username in case-sensitive");
