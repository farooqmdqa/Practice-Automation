...
public class TestNG_TC5_Login_Invalidcredentials {
	...
	// Create a method "invalidCredentials" to enter empty username and empty password, and click Login button.
	@Test
	...
	public void validateLogin() {
		...
		//Assert.assertEquals(actual_text,exp_text,"TC5_Login_InvalidCredentials is failed");
		
		Assert.assertTrue(actual_text.contains(exp_text), "TC5_Login_InvalidCredentials is failed!");
		
		System.out.println("TC5_Login_InvalidCredentials is passed!");
