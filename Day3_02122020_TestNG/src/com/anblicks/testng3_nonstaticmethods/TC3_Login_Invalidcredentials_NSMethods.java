...
public class TC3_Login_Invalidcredentials_NSMethods {
	...
	// Create a method(non-static) "invalidCredentials" to enter correct username and empty password, and click Login button.
