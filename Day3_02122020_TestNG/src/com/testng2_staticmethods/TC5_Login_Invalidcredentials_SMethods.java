...
public class TC5_Login_Invalidcredentials_SMethods {
	...
	// Create a method(static) "invalidCredentials" to enter empty username and empty password, and click Login button.
